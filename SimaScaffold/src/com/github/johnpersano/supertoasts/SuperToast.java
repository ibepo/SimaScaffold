...
public class SuperToast {
	...
	/**
	 * Custom OnClickListener to be used with
	 * SuperActivityToasts/SuperCardToasts. Note that
	...
	/**
	 * Custom OnDismissListener to be used with any type of SuperToasts. Note
	 * that SuperActivityToasts/SuperCardToasts must use this with an
	...
	public SuperToast(Context context) {
		...
		mWindowManager = (WindowManager) mToastView.getContext().getApplicationContext()
	 ...
	 *            {@link android.content.Context}
	 * @param style
	 *            {@link com.github.johnpersano.supertoasts.util.Style}
	 */
	...
	public int getmAnimationsStyle() {
		return mAnimationsStyle;
	}

	public void setmAnimationsStyle(int mAnimationsStyle) {
		this.mAnimationsStyle = mAnimationsStyle;
	}
	 ...
	 * 
	 * @param iconResource
	 *            {@link com.github.johnpersano.supertoasts.SuperToast.Icon}
	 * @param iconPosition
	 *            {@link com.github.johnpersano.supertoasts.SuperToast.IconPosition}
	 */
	public void setIcon(int iconResource, IconPosition iconPosition) {

		if (iconPosition == IconPosition.BOTTOM) {

			mMessageTextView.setCompoundDrawablesWithIntrinsicBounds(null, null, null, mContext.getResources()
					.getDrawable(iconResource));

		} else if (iconPosition == IconPosition.LEFT) {

			mMessageTextView.setCompoundDrawablesWithIntrinsicBounds(mContext.getResources().getDrawable(iconResource),
					null, null, null);
	 ...
	 * 
	 * @param background
	 *            {@link com.github.johnpersano.supertoasts.SuperToast.Background}
	 */
	...
	/**
	 * Sets an OnDismissListener defined in this library to the {@value #TAG}.
	 * Does not require wrapper.
	 * 
	 * @param onDismissListener
	 *            {@link com.github.johnpersano.supertoasts.SuperToast.OnDismissListener}
	 */
